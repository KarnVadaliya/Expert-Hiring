    ...
    return (
        <div id="DIV_1">
                    ...
                    <div id="DIV_4">
                        <div id="DIV_5">
                            ...
                            <section id="SECTION_6">
                                <img className="about-us-header-image" src="./yoganew.png" />
                                <div id="DIV_7">
                                    {/* <img src="./yoga2.png" id="IMG_25" /> */}
                                    <div id="DIV_8">
                                        <div id="DIV_9">
                                            <h1 id="H1_10">
                        ...
                        <div id="DIV_17">
                            <div id="DIV_18">
                                <div id="DIV_19">
                                    ...
                                    <div id="DIV_23">
                                        <div id="DIV_24">
                                            <img src="mission.png" alt="brian halligan and dharmesh shah" id="IMG_25" /><img src="https://www.hubspot.com/hubfs/assets/hubspot.com/about_2019/blobs/Blop-Gray@2x.png" alt="brian halligan signature blob" id="IMG_26" />
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div className="superbox">
                <div className="box">
                    <img className="person" src="profile.jpg"></img>
                    <br></br>

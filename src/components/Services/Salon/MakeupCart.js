...
class MakeupCart extends Component {
    ...
    getList = (name) => {
        switch (name) {
            case 'Party Makeup':
                return global.partyMakeupList;
            case 'Bridal Makeup':
                return global.bridalMakeupList;
            default:
                break;
        }
    }
    ...
    render() {
        ...
        const partyCategory = [];
        tempList.map(product => {
            if (product.category === 'Party Makeup')
                partyCategory.push(product);
        });


        const bridalCategory = [];
        tempList.map(product => {
            if (product.category === 'Bridal Makeup')
                bridalCategory.push(product);
        });
        ...
        global.partyMakeupList = (partyCategory.length) ? (
            partyCategory.map(product => {
                return (
        ...
        global.bridalMakeupList = (bridalCategory.length) ? (
            bridalCategory.map(product => {
                return (
                    <ProductCard product={product} />
                )
            })

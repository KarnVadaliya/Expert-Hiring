...
class MakeupAndHair extends Component {
                    ...
                    <div className="serviceBoxButtons">
                        ...
                        <div className="serviceButtonGroup">
                            ...
                            <button onClick={() => this.props.history.push('/salon/makeup/shop')}>
                                Make Up <i style={{ textAlign: "right" }} className="fa fa-chevron-right" />
                            </button>

                            <button onClick={() => this.props.history.push('/salon/makeup/shop')}>
                                Hair Styling<i className="fa fa-chevron-right"></i>
                            </button>
                        </div>
                    </div>
